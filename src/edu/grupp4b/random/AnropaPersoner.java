...
public class AnropaPersoner {
	...
	randomSkidakare[5] = "Oskar Kardin, SWE, Nacka Värmdö SK ";
	...
	randomSkidakare[9] = "Erica Kveli, FIN, Mäenpää IF";
	
	// int randomNumber = random.nextInt(randomSkidakare.length);
	// String printSkidakare = randomSkidakare[randomNumber];
